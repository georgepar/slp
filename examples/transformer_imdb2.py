...
from slp.data.imdb_data import get_imdb
...
from slp.trainer import TransformerImdbSequentialTrainer # , SequentialTrainer
...
#    word2idx, _, embeddings = loader.load()
    ...
    train_loader, test_loader, embeddings, _ = get_imdb(BATCH_SIZE, MAX_LENGTH)
    ...
    trainer = TransformerImdbSequentialTrainer(
