...
from slp.modules.vat import ConditionalEntropyLoss, DACELoss
...
if __name__ == '__main__':
    ...
    source_dataset = AmazonZiser17(ds="kitchen", dl=0, labeled=True)
    ...
    target_dataset = AmazonZiser17(ds="electronics", dl=1, labeled=False)
    ...
    test_dataset = AmazonZiser17(ds="electronics", dl=1, labeled=True)
    ...
    criterion = DACELoss(cl_loss, da_loss, trg_cent_loss)
    metrics = {
        'loss': Loss(criterion),
